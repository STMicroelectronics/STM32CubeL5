...
To run this application, the user can use one of the following configuration:
 ...
 - Configuration 2:
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the STM32L552E-EV board
...
@par Hardware and Software environment
  ...
  The USART3  interface available on PB10 and PB11 of the microcontroller can be
