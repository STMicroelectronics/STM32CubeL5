...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED4 on the STM32L552E-EV board is
    provided in Binary directory.

@note After each device reset (unplug the STM32L552E-EV board from PC), Plug the STM32L552E-EV board with Key WKUP push-button button
...
@note A binary which toggles LED1 on the STM32L552E-EV board is provided in Binary directory.
...
@note The build-in USB peripheral of the stm32l5xx does not provide a specific interrupt for USB cable plug/unplug
...
@par Directory contents
  ...
  - USB_Device/DFU_Standalone/Core/Src/system_stm32l5xx.c         stm32l5xx system clock configuration file
  - USB_Device/DFU_Standalone/Core/Src/stm32l5xx_it.c             Interrupt handlers
  - USB_Device/DFU_Standalone/Core/Src/stm32l5xx_hal_msp.c        HAL MSP Module
  ...
  - USB_Device/DFU_Standalone/Core/Inc/stm32l5xx_it.h             Interrupt handlers header file
  - USB_Device/DFU_Standalone/Core/Inc/stm32l5xx_hal_conf.h       HAL configuration file
...
In order to make the program work, you must do the following:
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo", choose the "stm32l552e_eval_LED_Toggle_@0x0800C000.dfu" provided in Core\Binary
