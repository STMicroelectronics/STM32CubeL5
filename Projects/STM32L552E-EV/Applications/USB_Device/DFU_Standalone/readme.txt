...
@note A binary which toggles LED4 on the STM32L552E-EV board is provided in Binary directory.
...
In order to make the program work, you must do the following:
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo", choose the "stm32l552e_eval_LED_Toggle_@0x0800C000.dfu" provided in Binary
