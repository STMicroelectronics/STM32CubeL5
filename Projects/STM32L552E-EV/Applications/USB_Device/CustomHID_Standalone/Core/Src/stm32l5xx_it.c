...
/**
  ******************************************************************************
  * @file    USB_Device/CustomHID_Standalone/Core/Src/stm32l5xx_it.c
...
/* USER CODE BEGIN 1 */
/**
  * @brief  This function handles External lines (EXTI13) interrupt request.
  * @param  None
  * @retval None
  */
...
/**
  * @brief  This function handles External lines (EXTI1) interrupt request.
  * @param  None
  * @retval None
  */
