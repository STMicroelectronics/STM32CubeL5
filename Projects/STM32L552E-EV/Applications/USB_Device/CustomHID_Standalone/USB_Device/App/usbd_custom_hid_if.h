...
/**
  ******************************************************************************
  * @file    USB_Device/CustomHID_Standalone/USB_Device/App/usb_customhid_if.h
  * @author  MCD Application Team
  * @brief   Header for usb_customhid_if.c file.
  ******************************************************************************
  * @attention
  *
...
#define LED4_REPORT_ID           0x01
#define LED4_REPORT_COUNT        0x01

#define LED5_REPORT_ID           0x02
#define LED5_REPORT_COUNT        0x01

#define LED6_REPORT_ID           0x03
#define LED6_REPORT_COUNT        0x01

#define LED7_REPORT_ID           0x04
#define LED7_REPORT_COUNT        0x01

#define BUTTON_WAKEUP_REPORT_ID    0x05
#define BUTTON_TAMPER_REPORT_ID    0x06
