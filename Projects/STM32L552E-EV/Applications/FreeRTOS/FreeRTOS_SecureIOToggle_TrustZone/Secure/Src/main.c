...
int main(void)
{
  ...
  /* Release them all to non-secure except PB.03 (LED4) kept as secure */
  ...
  HAL_GPIO_ConfigPinAttributes(GPIOB, (GPIO_PIN_All & ~(GPIO_PIN_3)), GPIO_PIN_NSEC);
  ...
  /* Initialize PB.03 to drive external LED (LED4) */
  BSP_LED_Init(LED4);
