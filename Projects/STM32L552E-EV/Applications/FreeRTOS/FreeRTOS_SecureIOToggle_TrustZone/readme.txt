...
The secure IO is PB.03 which corresponds to LED4 and the non-secure application switches on
the non-secure IO PD.03 which corresponds to LED5 when an error occurs.
...
@par Directory contents
  ...
  - Secure/Inc/stm32l552e_eval_conf.h            Secure Eval board configuration header file
