...
int main(void)
{
  ...
  Fill_Buffer(aTxBuffer, BUFFER_SIZE, 0xB1F0);
  ...
  if(uwWriteReadStatus != PASSED)
  {
    ...
    while (1)
    {
      /* LED4 will blink with 1s period */
      BSP_LED_Toggle(LED4);
      HAL_Delay(500U);
    }
  }
...
static void MX_GTZC_S_Init(void)
{
  ...
  MPCWM_ConfigTypeDef MPCWM2_NonSecureArea1_Desc = {0};
  MPCBB_ConfigTypeDef MPCBB_NonSecureArea_Desc = {0};

  /* USER CODE BEGIN GTZC_S_Init 1 */

  /* USER CODE END GTZC_S_Init 1 */
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_FMC_REG, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_NPRIV) != HAL_OK)
  {
    Error_Handler();
  }
  MPCWM2_NonSecureArea1_Desc.AreaId = GTZC_TZSC_MPCWM_ID1;
  MPCWM2_NonSecureArea1_Desc.Offset = 0x80000;
  MPCWM2_NonSecureArea1_Desc.Length = 0x80000;
  MPCWM2_NonSecureArea1_Desc.Attribute = GTZC_TZSC_MPCWM_REGION_NSEC ;
  if (HAL_GTZC_TZSC_MPCWM_ConfigMemAttributes(FMC_BANK1, &MPCWM2_NonSecureArea1_Desc) != HAL_OK)
  {
    Error_Handler();
  }
