...
* @param  data_lenght: Blood Pressure Measurement characteristic value length
...
* @param  data_lenght: Intermediate Cuff Pressure characteristic value length
...
/**
 * @brief This callback returns the status of the characteristic enable indication procedure on the
