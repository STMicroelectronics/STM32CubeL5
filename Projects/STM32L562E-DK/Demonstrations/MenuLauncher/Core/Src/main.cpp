...
extern volatile unsigned int SoftwareReset;
/* USER CODE END PV */
...
int main(void)
{
...
#if defined(CALIBRATION_TS)
    /* Check User key for calibration request */
    ...
    if((SoftwareReset == 0) || (button_press == 1))
    {

      /* Check initial TS calibration done) */
      Touchscreen_Calibration(240, 240);
    }
#endif

    WRITE_REG(BKP_REG_SW_CFG, 0x01);
    WRITE_REG(BKP_REG_SUBDEMO_ADDRESS, 0x00);
