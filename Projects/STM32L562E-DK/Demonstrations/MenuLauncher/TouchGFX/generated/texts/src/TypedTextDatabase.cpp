...
extern touchgfx::GeneratedFont& getFont_NotoSans_Regular_13_4bpp();
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        _fonts[0] = &(getFont_NotoSans_Regular_20_4bpp());
        break;
    case 1:
        _fonts[1] = &(getFont_NotoSans_Regular_40_4bpp());
        break;
    case 2:
        _fonts[2] = &(getFont_NotoSans_Regular_13_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
