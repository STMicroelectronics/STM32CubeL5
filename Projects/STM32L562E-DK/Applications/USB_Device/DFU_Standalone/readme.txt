...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED10 on the STM32L562E-DK board is
    provided in Binary directory.

@note After each device reset (unplug the STM32L562E-DK board from PC), Plug the STM32L562E-DK board with Key User push-button button
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics STM32L562E-DK
