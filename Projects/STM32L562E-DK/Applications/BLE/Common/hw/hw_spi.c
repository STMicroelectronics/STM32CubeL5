...
#define BNRG_SPI_RESET_PORT             GPIOG
#define BNRG_SPI_RESET_CLK_ENABLE()     __HAL_RCC_GPIOG_CLK_ENABLE()
#define BNRG_SPI_RESET_STDBY_PIN        LL_PWR_GPIO_BIT_8
#define BNRG_SPI_RESET_STDBY_PORT       LL_PWR_GPIO_G

  // SCLK: 
#define BNRG_SPI_SCLK_PIN               GPIO_PIN_2
...
#define BNRG_SPI_SCLK_PORT              GPIOG
#define BNRG_SPI_SCLK_CLK_ENABLE()      __HAL_RCC_GPIOG_CLK_ENABLE()

  // MISO (Master Input Slave Output): 
#define BNRG_SPI_MISO_PIN               GPIO_PIN_3
...
#define BNRG_SPI_MISO_PORT              GPIOG
#define BNRG_SPI_MISO_CLK_ENABLE()      __HAL_RCC_GPIOG_CLK_ENABLE()

  // MOSI (Master Output Slave Input): 
#define BNRG_SPI_MOSI_PIN               GPIO_PIN_4
...
#define BNRG_SPI_MOSI_PORT              GPIOG
#define BNRG_SPI_MOSI_CLK_ENABLE()      __HAL_RCC_GPIOG_CLK_ENABLE()
#define BNRG_SPI_MOSI_STDBY_PIN         LL_PWR_GPIO_BIT_4
#define BNRG_SPI_MOSI_STDBY_PORT        LL_PWR_GPIO_G

  // NSS/CSN/CS: PA.1
#define BNRG_SPI_CS_PIN                 GPIO_PIN_5
...
#define BNRG_SPI_CS_PORT                GPIOG
#define BNRG_SPI_CS_CLK_ENABLE()        __HAL_RCC_GPIOG_CLK_ENABLE()
#define BNRG_SPI_CS_STDBY_PIN           LL_PWR_GPIO_BIT_5
#define BNRG_SPI_CS_STDBY_PORT          LL_PWR_GPIO_G
...
#define BNRG_SPI_IRQ_CLK_ENABLE()       __HAL_RCC_GPIOG_CLK_ENABLE()
...
#define BNRG_SPI_TX_DMA_REQUEST           DMA_REQUEST_SPI1_TX
...
#define BNRG_SPI_RX_DMA_REQUEST           DMA_REQUEST_SPI1_RX
      ...
      case SPI_CHECK_RECEIVED_HEADER_FOR_RX:
        ...
        if ((byte_count == 0) || (ready_state != BLUENRG_READY_STATE))
        {
          if (HAL_GPIO_ReadPin(BNRG_SPI_IRQ_PORT, BNRG_SPI_IRQ_PIN) == GPIO_PIN_RESET)
          {
             ...
             * the specification.
             * This checking will popping BluenRG for a dummy event
             */
