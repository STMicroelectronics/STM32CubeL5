                                                    ...
                                                    enum ecc_curve_t *curve_type)
{
  ...
  priv_key_dst  = (uint32_t *)key_buf;
  /* private key is recopied from Tamper Back up register : tamper backup register access is privileged and secure */
  /* destination is not checked since read required privileged  */
