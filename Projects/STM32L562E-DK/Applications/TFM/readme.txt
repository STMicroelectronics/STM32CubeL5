...
For more details, refer to UMxxxx "Getting started with TFM"
available from the STMicroelectronics microcontroller website www.st.com.

@par Directory contents

   - Linker     Linker files definition shared between TFM_SBSFU and TFM_Appli
   - TFM_Appli  Secure services application and example of non-secure user
                application. Refer to TFM_Appli\readme.txt.
   - TFM_SBSFU  Secure boot and secure firmware update application
                Refer to TFM_SBSFU\readme.txt.
...
1. Build
   ...
   1- Build TFM_SBSFU project.
      ...
      Depending on toolchain, it is located here:
        STM32CubeIDE: TFM_SBSFU\STM32CubeIDE\Release\TFM_SBSFU.bin
        EWARM:        TFM_SBSFU\EWARM\STM32L562E-DK_TFM_SBSFU\Exe\Project.bin
        MDK-ARM:      TFM_SBSFU\MDK-ARM\STM32L562E-DK\Exe\Project.bin
...
2. Initialize the device
   ...
   shot:
     STM32CubeIDE: TFM_SBSFU\STM32CubeIDE\regression.bat or regression.sh
     EWARM:        TFM_SBSFU\EWARM\regression.bat
     MDK-ARM:      TFM_SBSFU\MDK-ARM\regression.bat
...
4. Program the TFM into internal flash
   ...
   flash in one shot:
     STM32CubeIDE: TFM_SBSFU\STM32CubeIDE\TFM_UPDATE.bat or TFM_UPDATE.sh
     EWARM:        TFM_SBSFU\EWARM\TFM_UPDATE.bat
     MDK-ARM:      TFM_SBSFU\MDK-ARM\TFM_UPDATE.bat

5. Reset the board

   Press the board reset button, and check the log information on the terminal
   emulator:
     - TFM_SBSFU application starts
...
7. Use User App
   ...
   1. Press 1 to enter New Fw Download menu
      ...
      installed and executed, by TFM_SBSFU.
