...
/* area for flashing images */
  ...
  RE_IMAGE_NUMBER = (0x2),
  RE_CODE_START_NON_SECURE = (OSPI_FLASH_BASE_ADDRESS+FLASH_AREA_1_OFFSET+0x400),
  RE_IMAGE_FLASH_ADDRESS_NON_SECURE = (OSPI_FLASH_BASE_ADDRESS+FLASH_AREA_1_OFFSET),
