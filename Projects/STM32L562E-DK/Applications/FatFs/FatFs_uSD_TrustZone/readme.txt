/**
  @page Description of the FatFs_uSD_TrustZone application with TZEN=1

  @verbatim
  ******************************************************************************
  * @file    FatFs/FatFs_uSD_TrustZone/readme.txt
  * @author  MCD Application Team
  * @brief   Description of the FatFs_uSD_TrustZone application with TZEN=1
  ******************************************************************************
  *
...
How to use FatFs stack with enabled TrustZone feature (TZEN=1).

This example develops an application that exploits FatFs
features to configure a microSD drive when TrustZone security is activated (Option bit TZEN=1). 

The purpose of this example is to configure SDMMC as secure. And to exploits FatFs features 
with an non-secure/secure access. FatFs is configured only in non-secure part.

This project is composed of two sub-projects:
- one for the secure application part (Project_s)
- one for the non-secure application part (Project_ns).

STM32L562E-DK's LED can be used to monitor the application status:
  - LED10 is ON when the application runs successfully.
...
@par Directory contents
  ...
  - Secure/Inc/stm32l562e_discovery_conf.h        BSP configuration header file
  ...
  - NonSecure/FATFS/Target/sd_diskio.c            FatFs uSD diskio driver
  - NonSecure/FATFS/App/app_fatfs.c               FatFs application code
  ...
  - NonSecure/FATFS/Target/ffconf.h                FAT file system module configuration file
  - NonSecure/FATFS/Target/sd_diskio.h            uSD diskio header file
  - NonSecure/FATFS/Target/stm32l562e_discovery_conf.h BSP configuration file
  - NonSecure/FATFS/App/app_fatfs.h               Header file for App_fatfs.c file
