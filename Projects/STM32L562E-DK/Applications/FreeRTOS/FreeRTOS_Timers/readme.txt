...
This application creates a thread that toggle LED10 every 400 ms, and a periodic 
timer that calls a callback function every 200 ms to toggle the LED9.  
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_Timers/Inc/stm32l5xx_it.h               Interrupt handlers header file
