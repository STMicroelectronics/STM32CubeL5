...
In the first 5 seconds, the thread 1 toggles LED9 each 200 ms and the 
thread 2 toggles LED10 each 500 ms.
In the following 5 seconds, the thread 1 suspends itself and the thread 2
continue toggling LED10.
In the last 5 seconds, the thread 2 resumes execution of thread 1 then 
suspends itself, the thread 1 toggles the LED9 each 500 ms.    
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_ThreadCreation/Inc/stm32l562e_discovery_hal_conf.h         BSP Configuration file
