...
:: no nsclib copy needed when secure postbuild with MDK-ARM, nsclib is managed by linker command directly
...
set "tfm_s=%projectdir%\NUCLEO-L552ZE-Q_S\Exe\Project.bin"
set "tfm_ns=%projectdir%\NUCLEO-L552ZE-Q_NS\Exe\Project.bin"
