...
__Vectors       DCD     |Image$$ARM_LIB_STACK$$ZI$$Limit| ; Top of Stack
                ...
                DCD     RTC_IRQHandler_S          ; RTC secure interrupts through the EXTI line
                DCD     TAMP_IRQHandler           ; Tamper non-secure interrupts through the EXTI line
                DCD     TAMP_IRQHandler_S         ; Tamper secure interrupts through the EXTI line
                DCD     FLASH_IRQHandler          ; FLASH non-secure interrupts
                DCD     FLASH_IRQHandler_S        ; FLASH secure global interrupts
                DCD     SERR_IRQHandler           ; Secure Error interrupts
                DCD     RCC_IRQHandler            ; RCC non-secure global interrupts
                DCD     RCC_IRQHandler_S          ; RCC secure global interrupts
                ...
                DCD     DMAMUX1_IRQHandler_S      ; DMAMUX1 secure
...
Default_Handler PROC
                ...
                EXPORT  RTC_IRQHandler_S          [WEAK]
                EXPORT  TAMP_IRQHandler           [WEAK]
                EXPORT  TAMP_IRQHandler_S         [WEAK]
                EXPORT  FLASH_IRQHandler          [WEAK]
                EXPORT  FLASH_IRQHandler_S        [WEAK]
                EXPORT  SERR_IRQHandler           [WEAK]
                EXPORT  RCC_IRQHandler            [WEAK]
                EXPORT  RCC_IRQHandler_S          [WEAK]
                ...
                EXPORT  DMAMUX1_IRQHandler_S      [WEAK]
