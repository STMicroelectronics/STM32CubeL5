...
Communication Class (CDC) following the PSTN sub-protocol on the STM32L5xx devices.

This example is part of the USB Device Library package using STM32Cube firmware.
This is a typical application on how to use the STM32L5xx USB Device peripheral where the STM32 MCU
...
To run this application, the user can use one of the following configuration:
 ...
 - Configuration 2:
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the NUCLEO-L552ZE-Q board
...
@par Directory contents
  ...
  - USB_Device/CDC_Standalone/Core/Src/system_stm32l5xx.c       STM32L5xx system clock configuration file
  - USB_Device/CDC_Standalone/Core/Src/stm32l5xx_it.c           Interrupt handlers
  - USB_Device/CDC_Standalone/Core/Src/stm32l5xx_hal_msp.c      HAL MSP Module
  ...
  - USB_Device/CDC_Standalone/Core/Inc/stm32l5xx_it.h           Interrupt handlers header file
  - USB_Device/CDC_Standalone/Core/Inc/stm32l5xx_hal_conf.h     HAL configuration file
...
@par Hardware and Software environment
  ...
  - For loopback mode test: connect directly LPUART1 TX and RX pins,
  The LPUART1  interface available on PG7 and PG8 of the microcontroller can be
