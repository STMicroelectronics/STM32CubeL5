...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED1 on the NUCLEO-L552ZE-Q board is
    provided in Binary directory.

@note After each device reset (unplug the NUCLEO-L552ZE-Q board from PC), Plug the NUCLEO-L552ZE-Q board with Key User push-button button
...
@note A binary which toggles LED1 on the NUCLEO-L552ZE-Q board is provided in Binary directory.
