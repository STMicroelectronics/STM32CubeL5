...
Each time the user pushes the User push-button of the NUCLEO-L552ZE-Q board the semaphore 
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_SemaphoreFromISR/Inc/stm32l5xx_it.h               Interrupt handlers header file
