...
the non-secure IO PA.09 which corresponds to LED3 when an error occurs.
...
@par Directory contents
  ...
  - Secure/Inc/stm32l5xx_nucleo_conf.h           Secure NSP configuration header file
  ...
  - NonSecure/Inc/stm32l5xx_nucleo_conf.h        Non-secure BSP configuration header file
