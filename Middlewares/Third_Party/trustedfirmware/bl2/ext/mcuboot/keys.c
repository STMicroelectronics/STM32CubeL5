...
#endif
const unsigned char rsa_pub_key[] __attribute__((section(".provision"))) = {
...
#pragma location="provision"
#endif
const unsigned int rsa_pub_key_len __attribute__((section(".provision"))) = 398;
#if (MCUBOOT_IMAGE_NUMBER == 2)
#if defined(__ICCARM__)
#pragma location="provision"
#endif
const unsigned char rsa_pub_key_1[] __attribute__((section(".provision"))) = {
    0x30, 0x82, 0x01, 0x8a, 0x02, 0x82, 0x01, 0x81,
...
#pragma location="provision"
#endif
const unsigned int rsa_pub_key_len_1 __attribute__((section(".provision"))) = 398;
#endif
#endif
#else
