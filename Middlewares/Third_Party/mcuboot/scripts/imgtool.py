...
@click.option('-s', '--setting',type=BasedIntParamType(),
              required=True,
              help='search for window batch set variable')
@click.option('-d', '--division',type=BasedIntParamType(),
              required=False,default="0",
              help='divide the value')  
@click.option('-p', '--phexa',type=BasedIntParamType(),
...
def sign(key, align, version, pad_sig, header_size, pad_header, slot_size, pad, confirm,
         ...
         security_counter, boot_record, otfdec, primary_only):
...
@click.argument('outfile')
@click.argument('infile')
@click.option('-i', '--input-size', type=BasedIntParamType(), required=True,
              help='input padding size')
@click.option('-o', '--optional-size', type=BasedIntParamType(), required=False,default='0',
